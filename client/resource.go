...
type ResourceDeleteOpts struct {
	KeepTiebreaker bool `url:"keep_tiebreaker"`
}
...
func (n *ResourceService) Delete(ctx context.Context, resName, nodeName string, opts ...*ResourceDeleteOpts) error {
	...
	_, err = n.client.doDELETE(ctx, "/v1/resource-definitions/"+resName+"/resources/"+nodeName+"?"+val.Encode(), nil)
	return err
}
